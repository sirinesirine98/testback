...
const EchoT1Schema = new mongoose.Schema({
    ...
    echo_T1: { type: String, maxlength: 150, required: true },//textarea
...
const EchoT1 = mongoose.model('EchoT1', EchoT1Schema);

module.exports = EchoT1;
