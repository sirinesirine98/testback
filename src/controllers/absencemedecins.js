const Absencemedecin = require("../models/absencemedecins");
...
praticienremplacant,
    ...
    existData.datedebut = datedebut;
    existData.datefin = datefin;
    existData.motif = motif;
    existData.praticien = praticien;
    existData.praticienremplacant = praticienremplacant;
