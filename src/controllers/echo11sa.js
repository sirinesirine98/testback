const ConsultationEcho11SA = require("../models/echo11sa");
...
const UpdateData = async (req, res) => {
    ...
    existData.motif_echo_11sa=motif_echo_11sa;
    existData.patient=patient;
    existData.date_echo_11sa=date_echo_11sa;
