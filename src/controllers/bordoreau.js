const Bordoreau = require("../models/bordoreau");
...
const UpdateData = async (req, res) => {
    ...
    existData.borderaux_id=borderaux_id;
    existData.nom_medecin=nom_medecin;
    existData.code_conventiel=code_conventiel;
    existData.date_bordoreau=date_bordoreau;
